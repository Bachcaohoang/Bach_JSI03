...
function signIn() {
  const emailsi = document.getElementById('email').value;
  const passwordsi = document.getElementById('pass').value;
...
signInWithEmailAndPassword(auth, emailsi, passwordsi)
  .then((userCredential) => {  
      ...
      window.location.href ='http://127.0.0.1:5500/Sp%20cu%E1%BB%91i%20kh%C3%B3a/page.html'
  })
  .catch((error) => {
